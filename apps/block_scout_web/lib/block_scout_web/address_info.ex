defmodule BlockScoutWeb.AddressInfo do
  ...
  @address_map %{
    ...
    # others
    String.downcase("0x4A806a4851472F7cFd579d3FF5465F03c3c2B5d4") => "EuProGigant",
    String.downcase("0x21CF19e1FaF3A62f82B432f82152e8c5C0FdBdaF") => "EuProGigant",
    String.downcase("0x9f4ceE0eBD03a1e9E4DcffaF876873d7a3e9595c") => "EuProGigant",
    String.downcase("0x6E7bec8715955B6Cc90A5A1767cd981b90C5a245") => "EuProGigant",
    ...
    String.downcase("0xf596D17C4a3A5c92c4721627B9e5E5064651BF46") => "Materna",
    ...
    String.downcase("0xa76Fa6837A6ffc9F123F2193717A5965c68B0cbA") => "Catena-X",
    String.downcase("0xFaeb57c16D5E9A9f06c8c5dB12796f5a432Eb7d6") => "Catena-X",
    String.downcase("0xb501FDaad0F0863C4c72f7EB9Abc23965DCa973d") => "Catena-X",
    String.downcase("0xF62bF6371Ee020Cb2164Ac3C338514DBbb93A0D4") => "Catena-X",
